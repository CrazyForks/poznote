        ...
        <div class="modal-body">
            ...
            <div class="ui-custom-sections-scroll">
                ...
                <div class="ui-custom-items">
                        ...
                        <label class="ui-custom-item"><input type="checkbox" data-ui-key="card:markdown-live-formatting-card" checked><span><?php echo t_h('display.cards.markdown_live_formatting', [], 'Live markdown formatting'); ?></span></label>
